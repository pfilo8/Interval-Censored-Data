...
write.csv(data.frame(lambdas, nus, means), file="means.csv",row.names=FALSE)
write.csv(data.frame(lambdas, nus,vars), file="vars.csv",row.names=FALSE)
write.csv(data.frame(lambdas, nus,bias), file="bias.csv",row.names=FALSE)
write.csv(data.frame(lambdas, nus,mean_sq), file="mean_sq.csv",row.names=FALSE)
