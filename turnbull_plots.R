...
means  %>%
  ...
  ylab(TeX('Mean of Turbull estimator of $\\lambda$')) +
  ggtitle('Mean of Turbull estimator') +
  theme_minimal()
...
vars  %>%
  ...
  geom_line() +
  xlab(TeX('$\\lambda$ - lightbulb failure rate')) +
  ylab(TeX('Variance  of Turbull estimator of $\\lambda$')) +
  ggtitle('Variance of Turbull estimator') +
  theme_minimal()
...
bias %>%
  ...
  xlab(TeX('$\\lambda$ - lightbulb failure rate')) +
  ylab(TeX('Bias of Turbull estimator of $\\lambda$')) +
  ggtitle('Bias of Turbull estimator') +
  theme_minimal()
...
mean_sq  %>%
  ...
  geom_line() +
  xlab(TeX('$\\lambda$ - lightbulb failure rate')) +
  ylab(TeX('Mean square error of Turbull estimator of $\\lambda$')) +
  ggtitle('Mean square error of Turbull estimator') +
  theme_minimal()
